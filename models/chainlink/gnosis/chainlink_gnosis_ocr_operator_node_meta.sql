...
SELECT node_address, operator_name FROM (VALUES
  ...
  ('0x82e2dE20848E58CDDfea53Ad56cAB0471AE8BDcF', '{{mycelium}}'),
  ('0xFc7C442154C04C31203e2b94B96fd57C44ac003D', '{{mycelium}}'),
  ...
  ('0x577b17c9A02B7A360e0cf945D623D6C1ace6074c', '{{anyblockanalytics}}'),
  ('0x3036c926cCc3096beCF584E7523A1a57fdebba77', '{{anyblockanalytics}}'),
