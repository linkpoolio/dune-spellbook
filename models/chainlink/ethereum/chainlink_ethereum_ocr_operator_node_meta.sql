...
SELECT node_address, operator_name FROM (VALUES
  ...
  (0x47b9161Daf189017BF1b499455c65F9234DF3FA3, '{{anyblockanalytics}}'),
  (0xD084c90d0e486ade2c045374dB447b99f94811Ee, '{{armanino}}'),
  ...
  (0xf34aC04a28F7CB5324A167C96B24ADE9c742B44f, '{{mycelium}}'),
  (0xF7C7AEaECD2349b129d5d15790241c32eeE4607B, '{{mycelium}}'),
  ...
  (0xd461DCb175C22b31250f2D21d8034710853547Cb, '{{tokenfort}}'),
  (0xc43aD44BB86b8957278F5E4D05Ba36064fb7DF5B, '{{tokenfort}}'),
  (0xC4b732Fd121F2f3783A9Ac2a6C62fD535FD13FdA, '{{validationcapital}}'),
  (0x52e77F4356bB39cBA841dC3E9c28eCe86900d68A, '{{validationcapital}}'),
