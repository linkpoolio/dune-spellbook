...
SELECT node_address, operator_name FROM (VALUES
  ...
  ('0xF69D0bBc95db6287ef02F19E5B2789972f776C2F', '{{anyblockanalytics}}'),
  ('0xB834eD914228B68b0E1f3E4F1e168Ed2b580a35c', '{{anyblockanalytics}}'),
  ...
  ('0x56873b5E7299d2C0d4ab28d9128D734CF3bf8398', '{{mycelium}}'),
  ('0xB1f0D485227DbeCFf6F1c0F28a58bBa1a97D4D81', '{{mycelium}}'),
